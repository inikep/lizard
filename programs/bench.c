            ...
            if (!cCompleted) {   /* still some time to do compression tests */
                ...
                do {
                    ...
                    for (blockNb=0; blockNb<nbBlocks; blockNb++) {
                        size_t const rSize = LZ5_compress_HC(blockTable[blockNb].srcPtr, blockTable[blockNb].cPtr, (int)blockTable[blockNb].srcSize, (int)blockTable[blockNb].cRoom, cLevel);
